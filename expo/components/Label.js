...
import { Defs, Path, Text, TextPath, TSpan } from 'react-native-svg';
...
const Label = (props) => {
  ...
  return (
    <>
      ...
      <Text fill={labelColor} textAnchor={textAnchor} fontSize={labelSize} style={{ fontFamily: "Helvetica, Arial, sans-serif", fontWeight: "bolder", fontSize: "12px" }}>
